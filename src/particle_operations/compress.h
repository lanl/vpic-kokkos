...
struct DefaultCompress {
            ...
            )
    {
        ...
        Kokkos::View<size_t>::HostMirror clean_up_to_count_h = Kokkos::create_mirror_view(sp->clean_up_to_count);
	    ...
	    particles(write_to, particle_var::qp)  = particles(pull_from, particle_var::qp);
#endif
