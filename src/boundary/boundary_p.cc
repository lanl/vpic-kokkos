...
#ifdef PARTICLE_WEIGHT_FLOAT
                pi->w = sp->k_pc_soa_h.w(copy_index);
#elif defined PARTICLE_WEIGHT_SHORT
                pi->w = static_cast<float>(sp->k_pc_soa_h.w(copy_index))*sp->w;
...
//    LIST_FOR_EACH( sp, sp_list )
//    {
//        auto& particle_send = sp->k_pc_soa_h;
//
//        //const float   sp_q  = sp->q;
//        const int32_t sp_id = sp->id;
//
...
//
//            //int voxel = p0[i].i;
//            int voxel = particle_send.i(copy_index);
//
//            int face = voxel & 7;
//            voxel >>= 3;
//
//            //p0[i].i = voxel;
//            particle_send.i(copy_index) = voxel;
//
//            int64_t nn = neighbor[ 6*voxel + face ];
//
//            // TODO: Allow for absorbing boundaries
