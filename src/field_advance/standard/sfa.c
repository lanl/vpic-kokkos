...
new_standard_field_array( grid_t           * RESTRICT g,
  ...
  if( 1 ) {
    ...
    fa->kernel->advance_e         = hyb_advance_e;  //ARI where to put this?
    fa->kernel->advance_b         = hyb_advance_b;  //ARI where to put this?
    fa->kernel->clear_rhof        = hyb_clear_rhof;  //ARI where to put this?
    fa->kernel->smooth_eb         = hyb_smooth_eb;  //ARI where to put this?
    fa->kernel->smooth_moments    = hyb_smooth_moments;  //ARI where to put this?
    fa->kernel->smooth_b          = hyb_smooth_b;  //ARI where to put this?
    fa->kernel->energy_f          = hyb_energy_f;
