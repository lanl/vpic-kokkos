...
! creat view, open MPI file, etc
  ...
  fnames(9) = 'data/uez'
  fnames(10) = 'data/ne'
  fnames(11) = 'data/pe-xx'
  fnames(12) = 'data/pe-yy'
  fnames(13) = 'data/pe-zz'
  fnames(14) = 'data/pe-yz'
  fnames(15) = 'data/pe-xz'
  fnames(16) = 'data/pe-xy'

  fnames(17) = 'data/uix'
  fnames(18) = 'data/uiy'
  fnames(19) = 'data/uiz'
  fnames(20) = 'data/ni'
  fnames(21) = 'data/pi-xx'
  fnames(22) = 'data/pi-yy'
  fnames(23) = 'data/pi-zz'
  fnames(24) = 'data/pi-yz'
  fnames(25) = 'data/pi-xz'
  fnames(26) = 'data/pi-xy'

  fnames(27) = 'data/ubx'
  fnames(28) = 'data/uby'
  fnames(29) = 'data/ubz'
  fnames(30) = 'data/nb'
  fnames(31) = 'data/pb-xx'
  fnames(32) = 'data/pb-yy'
  fnames(33) = 'data/pb-zz'
  fnames(34) = 'data/pb-yz'
  fnames(35) = 'data/pb-xz'
  fnames(36) = 'data/pb-xy'
...
! Read in field data and load into global arrays
     ...
     call write_data(fnames(4),bx+bx0,tindex,output_record)
     call write_data(fnames(5),by+by0,tindex,output_record)
     call write_data(fnames(6),bz+bz0,tindex,output_record)
...
! Repeat for beam ions
     ...
     do dom_x = ht%start_x,ht%stop_x
        do dom_y = ht%start_y,ht%stop_y
           do dom_z = ht%start_z, ht%stop_z
              ...
              write(fname,"(A,I0,A,I0,A,I0)")"hydro/T.",tindex,"/Bhydro.",tindex,".",n-1        
              if (check) then 
                 open(unit=10,file=trim(fname),status='unknown',form='binary')
              else
                 print *,"Can't find file:",fname
     ...
     call write_data(fnames(27),ux,tindex,output_record)
     call write_data(fnames(28),uy,tindex,output_record)
     call write_data(fnames(29),uz,tindex,output_record)

     call write_data(fnames(30),ne,tindex,output_record)

     call write_data(fnames(31),pxx,tindex,output_record)
     call write_data(fnames(32),pyy,tindex,output_record)
     call write_data(fnames(33),pzz,tindex,output_record)
     call write_data(fnames(34),pyz,tindex,output_record)
     call write_data(fnames(35),pxz,tindex,output_record)
     call write_data(fnames(36),pxy,tindex,output_record)
