...
program translate
  ...
  real(kind=4), allocatable, dimension(:,:,:) :: ex,ey,ez,bx,by,bz,jx,jy,jz,rho,ne,ux,uy,uz,pxx,pyy,pzz,pxy,pxz,pyz,phi, phit, jsx, jsy,jsz,kes
...
! Allocate storage space for fields and moments
  ...
  allocate(jsx(ht%nx,ht%ny,ht%nz))
  allocate(jsy(ht%nx,ht%ny,ht%nz))
  allocate(jsz(ht%nx,ht%ny,ht%nz))
  allocate(kes(ht%nx,ht%ny,ht%nz))
...
! for ion hydro
              ...
              jsx(idxstart(n,1):idxstop(n,1), idxstart(n,2):idxstop(n,2), idxstart(n,3):idxstop(n,3)) = &
                 buffer(2:nc(1)-1,2:nc(2)-1,2:nc(3)-1)
              read(10)buffer 
              jsy(idxstart(n,1):idxstop(n,1), idxstart(n,2):idxstop(n,2), idxstart(n,3):idxstop(n,3)) = &
                 buffer(2:nc(1)-1,2:nc(2)-1,2:nc(3)-1)

              read(10)buffer 
              jsz(idxstart(n,1):idxstop(n,1), idxstart(n,2):idxstop(n,2), idxstart(n,3):idxstop(n,3)) = &
                 buffer(2:nc(1)-1,2:nc(2)-1,2:nc(3)-1)
              ...
              read(10)buffer
              kes(idxstart(n,1):idxstop(n,1), idxstart(n,2):idxstop(n,2), idxstart(n,3):idxstop(n,3)) = &
                 buffer(2:nc(1)-1,2:nc(2)-1,2:nc(3)-1)
