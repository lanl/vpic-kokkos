...
for slice in range(0,50,1):	
        ...
        im = ax1.pcolor(xv,zv,np.transpose(Q["ni"]),shading="nearest",vmin=0,vmax=10)#"nearest")    
        cbar=plt.colorbar(im,ax=ax1)
        im2 = ax1.contour(xv,zv,np.transpose(Q["Ay"]),levels=20,colors='white',linestyles='dashed')
